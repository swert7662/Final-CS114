...
public class FPSDisplay : MonoBehaviour {
    ...
    public Text avgfpsLabel, hifpsLabel, lofpsLabel;
    ...
    private void Update()
    {
        Display(hifpsLabel, fpsCounter.hiFPS);
        Display(avgfpsLabel, fpsCounter.avgFPS);
        Display(lofpsLabel, fpsCounter.loFPS);
    }
